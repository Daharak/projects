Проект с интерактивными картами доступен по [ссылке](ссылке: https://nbviewer.org/github/VASILEV-SERGEI/projects/blob/main/cafe_project/geo_cafe_project%20%282%29.ipynb "Нажми для перехода")
